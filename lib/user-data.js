...
// Set given challenge complete-status
function setChallengeComplete (challenge, isComplete) {
  const fileContent = getChallengeData()
  fileContent[challenge].challengeComplete = isComplete
...
exports.setChallengeComplete = setChallengeComplete
