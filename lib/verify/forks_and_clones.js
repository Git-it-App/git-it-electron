  ...
  remotes.forEach(remote => {
    if (remote.match('origin')) {
      if (remote.match('github.com[:/]' + username + '/')) {
        ...
        incomplete = true
        addToList(i18n.t('verify~No Origin remote found pointing to {{username}}/patchwork.', { username }), false)
      }
    }
    ...
    if (remote.match('upstream')) {
      if (remote.match('github.com[:/]jlord/')) {
        ...
        incomplete = true
        addToList(i18n.t('verify~No Upstream remote found pointing to jlord/patchwork.'), false)
      }
    }
  })
